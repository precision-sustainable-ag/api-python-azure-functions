...
def fetch_vwc(start_date, end_date, site):
    ...
    if (resp_status):
        ...
        if len(vwc_data) != 0:
            ...
            plot_graph(vwc_overall, "FetchReport\\MoistureGraph.png",
                       start_date, end_date)

            vwc_d = vwc_data[vwc_data["center_depth"] == -5]
            plot_graph(vwc_d, "FetchReport\\MoistureGraphD.png",
                       start_date, end_date, str(-5))
            vwc_c = vwc_data[vwc_data["center_depth"] == -15]
            plot_graph(vwc_c, "FetchReport\\MoistureGraphC.png",
                       start_date, end_date, str(-15))
            vwc_b = vwc_data[vwc_data["center_depth"] == -45]
            plot_graph(vwc_b, "FetchReport\\MoistureGraphB.png",
                       start_date, end_date, str(-45))
            vwc_a = vwc_data[vwc_data["center_depth"] == -80]
            plot_graph(vwc_a, "FetchReport\\MoistureGraphA.png",
