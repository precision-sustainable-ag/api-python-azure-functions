...
from UpdateProtocolsEnrolled import main  # import the method we want to test
...
class TestCreateGithubIssue(unittest.TestCase):
    def test_good_response(self):
        request = func.HttpRequest(
            ...
            body=json.dumps({"protocols_enrolled": "0"}).encode(),
            headers=HEADERS
        )
    ...
    def test_invalid_github_user(self):
        ...
        assert "failed to update protocols_enrolled" in json_response["details"]
